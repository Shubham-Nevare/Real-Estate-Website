      ...
      <footer className="bg-gray-900 text-white py-12">
        <div className="container mx-auto px-4">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
            <div>
              <h3 className="text-xl font-bold mb-4">Akruti Developers</h3>
            ...
            <div>
              ...
              <ul className="space-y-2">
                <li><a href="#" className="text-gray-400 hover:text-white transition">Residential Development</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition">Commercial Projects</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition">Construction Management</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition">Renovation & Restoration</a></li>
                <li><a href="#" className="text-gray-400 hover:text-white transition">Property Investment</a></li>
              </ul>
            </div>
          ...
          <div className="border-t border-gray-800 mt-8 pt-8 text-center text-gray-400 text-sm">
            <p>&copy; 2025 Akruti Developers. <b>Made by Shubham</b> All Rights Reserved.</p>
          </div>
        </div>
      </footer>
    </>
